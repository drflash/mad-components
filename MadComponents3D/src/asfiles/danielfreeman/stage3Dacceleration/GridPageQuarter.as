package com.danielfreeman.stage3Dacceleration {
	...
	import com.danielfreeman.stage3Dacceleration.GridPage;
	...
	public class GridPageQuarter extends GridPage {	
		...
		override public function pageTexture(page:IContainerUI, backgroundColour:uint = 0xFFFFFFFF):void {trace("pageTexture");
